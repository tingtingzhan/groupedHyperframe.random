...
| [`rMatClust`](https://search.r-project.org/CRAN/refmans/spatstat.random/html/rMatClust.html) | Matérn's cluster process [@Matern1986; @rMatClust], from package **`spatstat.random`** |
...
Example below simulates a `coords`-only, un`marked`, two `superimpose`d Matérn's cluster processes [@Matern1986] $(\kappa, \mu, s) = (10,8,.15)$ and $(5,4,.06)$.
