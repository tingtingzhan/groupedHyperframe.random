...
-   To specify a full variance-covariance matrix $\Sigma$, user should use function `MASS::mvrnorm()` [@MASS].
...
|:------------------------------------|:------------------------------------|
| [`|>`](https://search.r-project.org/R/refmans/base/html/pipeOp.html) | Forward pipe operator introduced since [R 4.1.0](https://cran.r-project.org/bin/windows/base/old/4.1.0/NEWS.R-4.1.0.html) |
