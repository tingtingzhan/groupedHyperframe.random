...
```{=html}
<!--
Package **`groupedHyperframe.random`** `Suggests` packages
...
Example below simulates an $x$- and $y$- `coords`-only, un`marked`, two `superimpose`d @Matern1986's cluster processes $(\kappa, \mu, s)$ `(kappa, mu, scale)` with parameters $(\kappa_1, \mu_1, s_1) = (10,8,.15)$ and $(\kappa_2, \mu_2, s_2) = (5,4,.06)$.
