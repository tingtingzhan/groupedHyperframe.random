...
c(
  ...
  '[`coords`](https://search.r-project.org/CRAN/refmans/spatstat.geom/html/coords.html)', '$x$- and $y$-coordinates',
  ...
  '[`rMatClust`](https://search.r-project.org/CRAN/refmans/spatstat.random/html/rMatClust.html)', 'Matern\'s cluster process', 
  '[`mvrnorm`](https://search.r-project.org/CRAN/refmans/MASS/html/mvrnorm.html), `rmvnorm_`', 'Multivariate normal random variable; `groupedHyperframe.random::rmvnorm_`',
  '[`rnbinom`](https://search.r-project.org/R/refmans/stats/html/NegBinomial.html)', 'Negative binomial random variable',
  '[`rpoispp`](https://search.r-project.org/CRAN/refmans/spatstat.random/html/rpoispp.html)', 'Poisson point pattern',
#  '`rStrauss`', 'Strauss process', '`spatstat.random::rStrauss`',
  '[`superimpose`](https://search.r-project.org/CRAN/refmans/spatstat.geom/html/superimpose.html)', 'Superimpose', 
...
Consider two `superimpose`d Matern's cluster processes attached with a log-normal `mark`. The population parameters are
